  ...
  const [contributions, setContributions] = useState<Contribution[]>([
    {
      ...
      contributions: [
        { url: 'https://github.com/elastic/elasticsearch/pull/53533', title: 'Enable support for decompression of compressed response within RestHighLevelClient' },
        { url: 'https://github.com/elastic/elasticsearch/pull/55413', title: 'Enable decompression of response within LowLevelRestClient' },
        { url: 'https://github.com/elastic/elasticsearch/pull/67802', title: 'Added support for passing http query parameters' },
      ],
    },
    {
      project: 'Tomcat',
      ...
      showProjectNameInRows: false,
      contributions: [
        { url: 'https://github.com/apache/tomcat/pull/673', title: 'Added option to use custom SSLContext' },
        { url: 'https://github.com/apache/tomcat/pull/805', title: 'Simplify usage of custom ssl configuration' },
      ],
    },
    {
      project: 'Http4k',
      ...
      contributions: [
        ...
        { url: 'https://github.com/http4k/http4k/pull/547', title: 'Start ApacheAsyncClient by default if not started yet' },
      ],
    },
    {
      ...
      contributions: [
        ...
        { url: 'https://github.com/eclipse-vertx/vert.x/pull/3719', title: 'Support for generic Key and Trust material', projectName: 'Vert.x' },
        { url: 'https://github.com/com-lihaoyi/requests-scala/pull/62', title: 'Support for custom SSLContext for ssl configuration', projectName: 'Requests-Scala' },
