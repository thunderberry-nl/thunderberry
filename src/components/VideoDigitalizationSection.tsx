        ...
        <section id="video-digitalization" className="bg-muted">
            <div className="max-w-6xl mx-auto">
                ...
                <span style={{position: 'absolute', left: '-9999px'}}>
                  Wij digitaliseren oude videobanden VHS, Hi8 en MIniDV in Hilversum
                </span>
                <p className="text-center text-muted-foreground mb-2 max-w-2xl mx-auto font-semibold">
                    Thunderberry offers VHS, Hi8, miniDV digitalization services in Hilversum
                </p>
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    Don't let your precious memories fade away. We convert your old video tapes into high-quality digital
                    files you can enjoy forever.
                </p>
