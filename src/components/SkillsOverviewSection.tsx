...
export default function SkillsOverviewSection() {
  ...
  const skills = [
    { name: "Java", logo: "https://static-00.iconduck.com/assets.00/java-icon-1511x2048-6ikx8301.png", backgroundColor: '#fff', padding: '12px' },
    { name: "Kotlin", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Kotlin_Icon.svg/1200px-Kotlin_Icon.svg.png", backgroundColor: '#fff', padding: '12px' },
    { name: "Scala", logo: "https://seeklogo.com/images/S/scala-logo-8570724313-seeklogo.com.png", backgroundColor: '#fff', padding: '12px' },
    ...
    { name: "Spring Boot", logo: "https://cdn.worldvectorlogo.com/logos/spring-3.svg", backgroundColor: '#fff', padding: '12px' },
    ...
    { name: "Google Dataflow", logo: "https://codelabs.developers.google.com/static/codelabs/cloud-dataflow-starter/img/62b0919755804bea.png", backgroundColor: '#fff', padding: '12px' },
    { name: "Google BigQuery", logo: "https://images.icon-icons.com/2699/PNG/512/google_bigquery_logo_icon_168150.png", backgroundColor: '#fff', padding: '12px' },
    { name: "Google Pub/Sub", logo: "https://cdn.worldvectorlogo.com/logos/google-cloud-pub-sub-logo.svg", backgroundColor: '#fff', padding: '12px' },
    { name: "Microsoft Azure", logo: "https://logos-world.net/wp-content/uploads/2021/02/Microsoft-Azure-Emblem.png", backgroundColor: '#fff', padding: '12px' },
    ...
    { name: "Kafka", logo: "https://cdn.freebiesupply.com/logos/thumbs/2x/kafka-logo.png", backgroundColor: '#fff', padding: '12px' },
    ...
    { name: "Apache Beam", logo: "https://beam.apache.org/images/logos/full-color/nameless/beam-logo-full-color-nameless-1000.png", backgroundColor: '#fff', padding: '12px' },
    ...
    { name: "MongoDB", logo: "https://www.svgrepo.com/show/331488/mongodb.svg", backgroundColor: '#fff', padding: '12px' },
    { name: "Confluence", logo: "https://cdn.worldvectorlogo.com/logos/confluence-1.svg", backgroundColor: '#fff', padding: '12px' },
    { name: "Jira", logo: "https://static-00.iconduck.com/assets.00/jira-icon-2048x2048-nufjgz6n.png", backgroundColor: '#fff', padding: '12px' },
    { name: "Slack", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Slack_icon_2019.svg/2048px-Slack_icon_2019.svg.png", backgroundColor: '#fff', padding: '12px' },
